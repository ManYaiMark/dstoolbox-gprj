...
urlpatterns = [
    ...
    path('admin/orders/<int:order_id>/detail/', views.detail_order, name='detail_order'),   
    
    path('admin/orders/<int:order_id>/add-item/', views.add_order_item, name='add_order_item'),
    path('admin/orders/<int:order_id>/update-item/<int:item_id>/', views.update_order_item, name='update_order_item'),
    path('admin/orders/<int:order_id>/delete-item/<int:item_id>/', views.delete_order_item, name='delete_order_item'),
